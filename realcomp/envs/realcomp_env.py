...
class REALCompEnv(MJCFBaseBulletEnv):
    ...
    def __init__(self, render=False):
        ...
        self.robot.used_objects = ["table", "cube", "tomato", "mustard"] #["table", "tomato", "mustard", "orange"]
        self.set_eye("eye")
    ...
    def get_retina(self):
        ...
        '''
        table_position = self.robot.object_bodies["table"].get_position()
        eye = self.eyes["eye"]
        return eye.render(table_position)
